...
class UnitChange:
    ...
    def toPgCyr(self):
        return self.ds*12/1000/1e12 # mol m-2 yr-1 --> PgC yr-1        

    def toKgCm2yr1(self):
        return self.ds*12/1000      # mol m-2 yr-1 --> KgC m2 yr-1        

    def togCm2yr1(self):
        return self.ds*12           # mol m-2 yr-1 --> gC m2 yr-1        
...
def change_units(dict_data,
                 ...
                 freq='mon'):
    '''
    Change international units to meteorological units 
    '''
